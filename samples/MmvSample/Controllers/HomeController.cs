...
using MvcSample.Bootstrap5.Models;
using System.Collections.Generic;
using System.Diagnostics;

namespace MvcSample.Bootstrap5.Controllers
{
    public class HomeController : Controller
    {
        public IActionResult Index()
        {
            List<CheckBoxItem> checkboxItems = new List<CheckBoxItem>()
            {
                ...
                new CheckBoxItem(3, "Id 3: Unchecked Disabled", false, true),
                new CheckBoxItem(4, "Id 4: Checked Disabled", true, true)
            };
